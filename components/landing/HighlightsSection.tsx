  ...
  return (
    <section className="mx-auto max-w-7xl px-8 py-16">
      <div className="grid auto-rows-[250px] grid-cols-1 gap-6 md:grid-cols-3">
        <div className="soft-shadow group relative flex flex-col justify-end overflow-hidden rounded-[2rem] bg-surface-container p-10 md:col-span-2">
        ...
        <div className="soft-shadow flex flex-col justify-end rounded-[2rem] border border-surface-container-highest bg-surface-bright p-10 transition-transform duration-300 hover:-translate-y-1">
        ...
        <div className="soft-shadow flex flex-col justify-end rounded-[2rem] bg-primary-container p-10 text-on-primary-container">
        ...
        <div className="soft-shadow relative overflow-hidden rounded-[2rem] bg-surface-bright md:col-span-2">
          <div
            aria-hidden="true"
          ...
          <div className="absolute bottom-0 left-0 z-10 w-full p-10">
            <h3 className="mb-2 font-headline text-2xl font-bold text-on-background">Built for the Future</h3>
            <p className="font-body text-on-surface-variant">Sustainable practices that respect the environment.</p>
          </div>
        </div>
      </div>
    </section>
